# decompile by Tech Khan
# source code by Tech Hamayun
# decompile done 3:)
...
def reg():
    ...
    print ''
    print ''
    print '\x1b[1;92m  [Connected With Hamayun Servers]'
    print ''
...
def reg2():
    ...
    print ''
    print '\x1b[1;96m '
    print ' \xe2\x80\xa2 THIS TOOL IS COMPLETELY CODED BY HAMAYUN KHAN \xe2\x80\xa2 '
    time.sleep(5)
    login()
...
def menu():
    ...
    print ''
    print ' [1] START'
    print ' [2] FOLLOW HAMAYUN KHAN ON FB '
